class Game {
  ...
  handleElements() {
    ...
    this.leadeboardTitle.position(width / 3 - 70, 10);

    this.leader1.class("leadersText");
    this.leader1.position(width / 3 - 50, 60);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
     /*  push();
      imageMode(CENTER); 
      image(track, width/2, -(height * 5)/2, width, height * 6);
      pop(); */
      //background(255);
